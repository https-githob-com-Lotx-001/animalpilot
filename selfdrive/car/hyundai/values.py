...
FEATURES = {
  ...
  "use_cluster_gears": set([CAR.ELANTRA, CAR.K7, CAR.ELANTRA_GT_I30, CAR.KONA]),
...
EV_CAR = set([CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.K7_HEV, CAR.KIA_NIRO_EV])
